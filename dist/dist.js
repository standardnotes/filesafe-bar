...
var _standardFileJs = __webpack_require__(1);
...
var ComponentKeyCredentialsKey = "ComponentKeyCredentialsKey";
...
var BridgeManager = function () {
  ...
  _createClass(BridgeManager, [{
    ...
    value: function setComponentData(key, value) {
      this.componentManager.setComponentDataValueForKey(key, value);
    }
  }, {
    key: 'getComponentData',
    value: function getComponentData(key) {
      return this.componentManager.componentDataValueForKey(key);
    }
  }, {
    key: 'loadOrCreateCredentials',
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var credentials, bits, identifer, password, _credentials;

        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                credentials = this.getComponentData(ComponentKeyCredentialsKey);
              ...
              case 11:
                _credentials = _context.sent;

                this.setComponentData(ComponentKeyCredentialsKey, _credentials);
...
var AppDomain = "org.standardnotes.filevault";
...
var Item = function () {
  ...
  _createClass(Item, [{
    ...
    key: 'dateToString',
    value: function dateToString(date, withTime) {
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(13),B=__webpack_require__(5),C=__webpack_require__(2),ba=__webpack_require__(14),da=__webpack_require__(15),ea=__webpack_require__(16),fa=__webpack_require__(17),ia=__webpack_require__(20),D=__webpack_require__(6);
...
var _BridgeManager = __webpack_require__(3);

var _BridgeManager2 = _interopRequireDefault(_BridgeManager);

var _FilesView = __webpack_require__(24);

var _FilesView2 = _interopRequireDefault(_FilesView);

var _IntegrationsView = __webpack_require__(30);

var _IntegrationsView2 = _interopRequireDefault(_IntegrationsView);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_FilesView2.default, null)
        )
      );
    }
  }]);
...
var _jsBase = __webpack_require__(25);
...
var FilesView = function (_React$Component) {
  _inherits(FilesView, _React$Component);

  function FilesView(props) {
    _classCallCheck(this, FilesView);

    var _this = _possibleConstructorReturn(this, (FilesView.__proto__ || Object.getPrototypeOf(FilesView)).call(this, props));
    ...
    _this.handleDroppedFiles = function (files) {
      ...
      reader.onload = function (e) {
        ...
        if (decrypt) {
          _this.decryptFile(data);
        } else {
          _this.encryptFile(data, file.name, file.type);
        }
      };
    ...
    _BridgeManager2.default.get().initiateBridge(function () {
      _BridgeManager2.default.get().loadOrCreateCredentials().then(function (credentials) {
  ...
  _createClass(FilesView, [{
    ...
    key: "encryptFile",
    value: function encryptFile(data, fileName, fileType) {
      var _this3 = this;
      ...
      SFJS.itemTransformer.encryptItem(item, this.keys, this.authParams).then(function (encryptedItem) {
        encryptedItem.uuid = item.uuid;
        _this3.downloadData(JSON.stringify(encryptedItem, null, 2 /* pretty print */), fileName + ".sf.json");
      });
    }
  }, {
    key: "decryptFile",
    value: function decryptFile(data) {
      var _this4 = this;

      var parsedData = JSON.parse(data);

      SFJS.itemTransformer.decryptItem(parsedData, this.keys).then(function () {
        var decryptedItem = new _item2.default(parsedData);
        // console.log("Decrypted item result:", decryptedItem);

        var urlData = decryptedItem.rawData;
        // console.log("Decrypted raw data", urlData);
        _this4.downloadData(_this4.dataURItoBinary(urlData), decryptedItem.fileName, decryptedItem.fileType);
      });
    }
  }, {
    key: "dataURItoBinary",
    value: function dataURItoBinary(dataURI) {
    ...
    key: "hrefForData",
    value: function hrefForData(data, fileType) {
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  " or select a file to add it to your vault."
                ),
...
var IntegrationsView = function (_React$Component) {
  _inherits(IntegrationsView, _React$Component);

  function IntegrationsView(props) {
    _classCallCheck(this, IntegrationsView);

    var _this = _possibleConstructorReturn(this, (IntegrationsView.__proto__ || Object.getPrototypeOf(IntegrationsView)).call(this, props));

    _this.handleTextChange = function (text) {
...
exports.default = IntegrationsView;
