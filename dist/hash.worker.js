...
var _standardFileJs = __webpack_require__(2);

var _RelayManager = __webpack_require__(6);
...
self.addEventListener('message', function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var data, fileItem, itemParamsObject;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (data.operation == "encrypt") {
              fileItem = new _standardFileJs.SFItem({
              ...
              itemParamsObject = new _standardFileJs.SFItemParams(fileItem, data.keys, data.authParams);

              itemParamsObject.paramsForSync().then(function (itemParams) {
                // Encryption complete
                self.postMessage({
              ...
              SFJS.itemTransformer.decryptItem(data.item, data.keys).then(function () {
                var decryptedItem = new _standardFileJs.SFItem(data.item);
              ...
              _RelayManager2.default.get().setCredentials(data.credentials);
              _RelayManager2.default.get().uploadFile(data.outputFileName, data.itemParams, data.integration).then(function (metadata) {
...
var RelayManager = function () {
  _createClass(RelayManager, null, [{
    key: "get",
    value: function get() {
      if (this.instance == null) {
        this.instance = new RelayManager();
      }
  ...
  function RelayManager() {
    ...
    this.httpManger = new _standardFileJs.SFHttpManager();
  ...
  _createClass(RelayManager, [{
    ...
    key: "uploadFile",
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, item, integration) {
        var _this = this;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                url = this.getRelayUrl() + "/integrations/save-item";
                params = {
                  file: {
                    name: name,
    ...
    key: "downloadFile",
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(metadataItem, integration) {
        var _this2 = this;
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                url = this.getRelayUrl() + "/integrations/download-item";
                params = {
    ...
    key: "deleteFile",
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(metadataItem, integration) {
        var _this3 = this;
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                url = this.getRelayUrl() + "/integrations/delete-item";
                params = {
                  metadata: metadataItem.content.serverMetadata,
                  authorization: integration.authorization
                };
